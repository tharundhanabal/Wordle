...
#----------------------------------
  ...
  #-------------------------------------
            def correct26():
              if answer[1] == wordle6[1]:
                return ("🟢")
  
              if answer[1] != wordle6[1]:
                if wordle6[1] in answer:
                  return ("🟡")
  ...
  #-------------------------------------
            def correct27():
              if answer[2] == wordle6[2]:
                return ("🟢")
  
              if answer[2] != wordle6[2]:
                if wordle6[2] in answer:
                  return ("🟡")
  ...
  #-------------------------------------
            def correct28():
              if answer[3] == wordle6[3]:
                return ("🟢")
  
              if answer[3] != wordle6[3]:
                if wordle6[3] in answer:
                  return ("🟡")
  ...
  #-------------------------------------
            def correct29():
              if answer[4] == wordle6[4]:
                return ("🟢")
  
              if answer[4] != wordle6[4]:
                if wordle6[4] in answer:
                  return ("🟡")
